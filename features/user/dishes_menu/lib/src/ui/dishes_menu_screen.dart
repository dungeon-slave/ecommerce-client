                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return DishItem(
                              ...
                              handler: (Offset childOffset) {
                                final AnimationController currController =
                                    AnimationController(
                                ...
                                final Animation<Rect?> currAnimation =
                                    RectTween(
                                  begin: Rect.fromLTWH(
                                    childOffset.dx +
                                ...
                                final AnimationModel currModel = AnimationModel(
                                ...
                                BlocProvider.of<MenuBloc>(context).add(
                                  AddDishEvent(
                                    model: state
                                        .items[state.currentTab].dishes[index],
                                  ),
                                );
